    ...
    public function run()
    {
        ...
        for ($i = 1; $i < 30; $i++) {
            Product::create([
                ...
                'description' => 'Lorem ' . $i . ' ipsum dolor sit amet consectetur adipisicing elit. Corrupti nihil repellat harum quidem culpa blanditiis provident, sequi in vitae illo.',
                'featured' => rand(0, 1),
            ])->categories()->attach(1);
        }
